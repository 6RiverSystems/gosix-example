...
require (
	...
	github.com/Depado/ginprom v1.7.3 // indirect
	...
	github.com/gin-contrib/logger v0.2.1 // indirect
	...
	modernc.org/sqlite v1.14.6-0.20220203141425-f4e26d2fda3b // indirect
